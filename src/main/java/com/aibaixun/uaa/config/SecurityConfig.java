...
import com.aibaixun.uaa.auth.RestAuthenticationProvider;
import com.aibaixun.uaa.auth.SkipPathRequestMatcher;
import com.aibaixun.uaa.entity.UserPrincipal;
import com.aibaixun.uaa.filter.*;
import com.aibaixun.uaa.handle.*;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    public static String authUrl="/uaa/token";
