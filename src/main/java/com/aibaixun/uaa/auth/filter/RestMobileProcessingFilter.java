...
public class RestMobileProcessingFilter  extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        if (StringUtils.isBlank(longinUser.get(SecurityConstants.MOBILE_FIELD)) || StringUtils.isBlank(longinUser.get(SecurityConstants.PASSWORD_FIELD))) {
            throw new AuthenticationServiceException("必须提供用户名和密码");
        }
        UserPrincipal principal = new UserPrincipal(UserPrincipal.Type.MOBILE,longinUser.get(SecurityConstants.MOBILE_FIELD));
